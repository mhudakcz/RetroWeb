Když Mattel v roce 1979 uvedl na trh **Intellivision** (zkratku z „Intelligent Television"), nešlo jen o další krabičku k televizi — byla to první vážná výzva tehdejší dominanci Atari 2600. Mattel vsadil na sílu marketingu i hardwaru: v slavné srovnávací reklamní kampani, kterou moderoval spisovatel a herec George Plimpton, ukazoval vedle sebe hrubou grafiku Atari a o poznání barevnější, jemnější obraz Intellivision. Konzole měla ambici působit jako „chytřejší" volba pro celou rodinu a stala se jedním z pilířů takzvané druhé generace herních konzolí. Do ukončení výroby v roce 1990 se jí prodalo zhruba tři miliony kusů a zanechala po sobě bohatou knihovnu sportovních, strategických i akčních titulů.

Charakteristickým prvkem se staly netradiční ovladače: ploché gamepady s číselnou klávesnicí, otočným diskem místo páčky a sadou bočních tlačítek. K mnoha hrám se navíc dodávaly papírové „overlay" šablony, které se vkládaly na klávesnici a popisovaly, co která číslice ve hře dělá. Bylo to řešení geniální i frustrující zároveň — disk byl pro některé žánry přesnější než joystick, ale tuhý a po čase poruchový.

### Technika: grafika a zvuk

Srdcem Intellivision byl 16bitový procesor **General Instrument CP1610**, taktovaný kolem 0,9 MHz. Šestnáctibitová architektura byla na svou dobu nezvyklá — Atari 2600 i pozdější NES běžely na 8bitových čipech — i když reálný výkon limitovala pomalá paměť a frekvence. Právě tento detail Mattel rád zdůrazňoval v marketingu.

O grafiku se staral specializovaný videočip **STIC (Standard Television Interface Chip), AY-3-8900**. Zobrazoval rozlišení 159 × 96 pixelů a paletu **16 barev**. Disponoval pozadím skládaným z dlaždic a osmi pohyblivými objekty (sprity, zde nazývané MOB — Moving Object Block), které šlo zvětšovat a zrcadlit. Výsledný obraz působil oblými, méně „kostkovanými" tvary než konkurence, což konzoli dávalo její typický vzhled.

Zvuk obstaral čip **General Instrument AY-3-8914**, příbuzný slavného AY-3-8910 z domácích počítačů. Nabízel **tři tónové kanály a generátor šumu**, takže hry zněly plnější a hudebnější než pípání jednodušších soupeřů. Pozdější rozšiřující modul Intellivoice dokonce přidával syntézu lidské řeči.

### Propojeni a periferie

Konzole se připojovala k televizi přes RF výstup. Ovladače byly v základní verzi pevně připojené kabelem, což znamenalo, že je nešlo snadno vyměnit — to se změnilo až u pozdějších revizí.
