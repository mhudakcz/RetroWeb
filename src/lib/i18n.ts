...
const UI: Dict = {
  ...
  'picks.title': { cs: 'Čím začít', en: 'Where to start', de: 'Womit anfangen', fr: 'Par où commencer' },
  'picks.lead': { cs: 'Když nevíte, co si pustit jako první — tyhle hry platformu vystihují nejlíp.', en: 'If you do not know what to play first — these games define the platform.', de: 'Wenn Sie nicht wissen, womit Sie anfangen sollen — diese Spiele prägen die Plattform.', fr: "Si vous ne savez pas par quoi commencer — ces jeux définissent la plateforme." },
  'zoom.open': { cs: 'Zvětšit obrázek', en: 'Enlarge image', de: 'Bild vergrößern', fr: "Agrandir l'image" },
  'zoom.close': { cs: 'Zavřít', en: 'Close', de: 'Schließen', fr: 'Fermer' },
  'zoom.prev': { cs: 'Předchozí obrázek', en: 'Previous image', de: 'Vorheriges Bild', fr: 'Image précédente' },
  'zoom.next': { cs: 'Další obrázek', en: 'Next image', de: 'Nächstes Bild', fr: 'Image suivante' },
  ...
  'home.jump': { cs: 'Přejít na typ platformy', en: 'Jump to platform type', de: 'Zum Plattformtyp', fr: 'Aller au type de plateforme' },
  ...
  'search.results.title': { cs: 'Výsledky hledání', en: 'Search results', de: 'Suchergebnisse', fr: 'Résultats de recherche' },
  'search.results.submit': { cs: 'Hledat', en: 'Search', de: 'Suchen', fr: 'Rechercher' },
  'search.results.count': { cs: 'Nalezeno {n} záznamů pro „{q}“', en: 'Found {n} results for “{q}”', de: '{n} Treffer für „{q}“', fr: '{n} résultats pour « {q} »' },
  'search.results.empty': { cs: 'Nic jsme nenašli. Zkuste kratší dotaz nebo jiné slovo.', en: 'Nothing found. Try a shorter query or a different word.', de: 'Nichts gefunden. Versuchen Sie eine kürzere Anfrage oder ein anderes Wort.', fr: 'Aucun résultat. Essayez une requête plus courte ou un autre mot.' },
  'search.results.short': { cs: 'Zadejte aspoň dvě písmena.', en: 'Type at least two letters.', de: 'Geben Sie mindestens zwei Buchstaben ein.', fr: 'Saisissez au moins deux lettres.' },
  ...
  'home.lead': {
    cs: 'Od arkádových automatů a osmibitových počítačů přes hry v prohlížeči a na mobilech až po dnešní konzole a virtuální realitu. Historie strojů, jejich nejlepší hry a tipy, kde si je zahrát dnes.',
    en: 'From arcade cabinets and 8-bit computers through browser and mobile games to today\u2019s consoles and virtual reality. The story of the machines, their best games and where to play them now.',
    de: 'Von Spielhallenautomaten und 8-Bit-Rechnern über Browser- und Handyspiele bis zu heutigen Konsolen und Virtual Reality. Die Geschichte der Maschinen, ihre besten Spiele und wo man sie heute spielt.',
    fr: 'Des bornes d\u2019arcade et des ordinateurs 8 bits aux jeux en navigateur et sur mobile, jusqu\u2019aux consoles actuelles et à la réalité virtuelle. L\u2019histoire des machines, leurs meilleurs jeux et où y jouer aujourd\u2019hui.',
  },
...
// ---- uzivatelsky ucet a znacky u her ----
  'ucet.prihlasit': { cs: 'Přihlásit se', en: 'Sign in', de: 'Anmelden', fr: 'Se connecter' },
  'ucet.odhlasit': { cs: 'Odhlásit se', en: 'Sign out', de: 'Abmelden', fr: 'Se déconnecter' },
  'ucet.email': { cs: 'E-mail', en: 'E-mail', de: 'E-Mail', fr: 'E-mail' },
  'ucet.poslatOdkaz': { cs: 'Poslat přihlašovací odkaz', en: 'Send sign-in link', de: 'Anmeldelink senden', fr: 'Envoyer le lien de connexion' },
  'ucet.odkazOdeslan': { cs: 'Přihlašovací odkaz jsme poslali na', en: 'We sent a sign-in link to', de: 'Wir haben einen Anmeldelink gesendet an', fr: 'Nous avons envoyé un lien de connexion à' },
  'ucet.odkazPokyn': { cs: 'Otevřete e-mail a klepněte na odkaz — vrátí vás sem už přihlášené. Pokud zpráva nedorazila, mrkněte do spamu.', en: 'Open the e-mail and tap the link — it brings you back here signed in. If nothing arrived, check your spam folder.', de: 'Öffnen Sie die E-Mail und tippen Sie auf den Link — er bringt Sie angemeldet hierher zurück. Falls nichts ankam, schauen Sie im Spam-Ordner nach.', fr: 'Ouvrez l’e-mail et cliquez sur le lien — il vous ramènera ici, connecté. Si rien n’est arrivé, vérifiez vos spams.' },
  'ucet.jinyEmail': { cs: 'Použít jiný e-mail', en: 'Use a different e-mail', de: 'Andere E-Mail verwenden', fr: 'Utiliser une autre adresse' },
  'ucet.znovu': { cs: 'Poslat odkaz znovu', en: 'Send the link again', de: 'Link erneut senden', fr: 'Renvoyer le lien' },
  'ucet.prihlasenJako': { cs: 'Přihlášen jako', en: 'Signed in as', de: 'Angemeldet als', fr: 'Connecté en tant que' },
  'ucet.pracuji': { cs: 'Pracuji…', en: 'Working…', de: 'Arbeite…', fr: 'En cours…' },
  'ucet.titulek': { cs: 'Přihlášení', en: 'Sign in', de: 'Anmeldung', fr: 'Connexion' },
  'ucet.lead': { cs: 'Přihlaste se e-mailem — heslo si pamatovat nemusíte. Pošleme vám odkaz, na který jednou klepnete, a zůstanete přihlášení.', en: 'Sign in with your e-mail — no password to remember. We send you a link, you tap it once and stay signed in.', de: 'Melden Sie sich mit Ihrer E-Mail an — kein Passwort nötig. Wir senden Ihnen einen Link, den Sie einmal antippen, und bleiben angemeldet.', fr: 'Connectez-vous par e-mail — aucun mot de passe à retenir. Nous vous envoyons un lien : un clic, et vous restez connecté.' },
  'ucet.kNecemu': { cs: 'K čemu to je', en: 'What it is for', de: 'Wozu das dient', fr: 'À quoi ça sert' },
  'ucet.kNecemuText': { cs: 'U každé hry si můžete označit, že vás zajímá nebo že jste ji hráli. Vznikne z toho seznam na později a hráčský deník — oboje najdete pod svým účtem, rozdělené po platformách.', en: 'On every game you can mark that it interests you or that you have played it. That gives you a list for later and a player diary — both live under your account, split by platform.', de: 'Bei jedem Spiel können Sie markieren, dass es Sie interessiert oder dass Sie es gespielt haben. Daraus entsteht eine Liste für später und ein Spieler-Tagebuch — beides finden Sie in Ihrem Konto, nach Plattform aufgeteilt.', fr: 'Sur chaque jeu, vous pouvez indiquer qu’il vous intéresse ou que vous y avez joué. Cela constitue une liste pour plus tard et un journal de joueur — les deux se trouvent dans votre compte, répartis par plateforme.' },

  'znacka.zajima': { cs: 'Zajímá mě', en: 'Interested', de: 'Interessiert mich', fr: 'Ça m’intéresse' },
  'znacka.hral': { cs: 'Hrál jsem', en: 'Played it', de: 'Gespielt', fr: 'J’y ai joué' },
  'znacka.prihlasSe': { cs: 'Přihlaste se a označte si hru', en: 'Sign in to mark this game', de: 'Melden Sie sich an, um das Spiel zu markieren', fr: 'Connectez-vous pour marquer ce jeu' },

  'seznam.titulek': { cs: 'Můj seznam', en: 'My list', de: 'Meine Liste', fr: 'Ma liste' },
  'seznam.lead': { cs: 'Hry, které jste si označili. Filtrujte podle platformy nebo typu značky, odznačit můžete rovnou tady.', en: 'The games you have marked. Filter by platform or by mark, and unmark right here.', de: 'Die von Ihnen markierten Spiele. Filtern Sie nach Plattform oder Markierung und heben Sie die Markierung gleich hier auf.', fr: 'Les jeux que vous avez marqués. Filtrez par plateforme ou par type de marque, et retirez la marque ici même.' },
  'seznam.vse': { cs: 'Vše', en: 'All', de: 'Alle', fr: 'Tout' },
  'seznam.vsechnyPlatformy': { cs: 'Všechny platformy', en: 'All platforms', de: 'Alle Plattformen', fr: 'Toutes les plateformes' },
  'seznam.hledat': { cs: 'Hledat v seznamu…', en: 'Search the list…', de: 'In der Liste suchen…', fr: 'Rechercher dans la liste…' },
  'seznam.prazdny': { cs: 'Zatím jste si nic neoznačili. Na detailu kterékoli hry najdete tlačítka „Zajímá mě“ a „Hrál jsem“.', en: 'You have not marked anything yet. On any game page you will find the “Interested” and “Played it” buttons.', de: 'Sie haben noch nichts markiert. Auf jeder Spielseite finden Sie die Schaltflächen „Interessiert mich“ und „Gespielt“.', fr: 'Vous n’avez encore rien marqué. Sur la page de chaque jeu, vous trouverez les boutons « Ça m’intéresse » et « J’y ai joué ».' },
  'seznam.nicNenalezeno': { cs: 'Tomuto filtru neodpovídá žádná hra.', en: 'No game matches this filter.', de: 'Kein Spiel entspricht diesem Filter.', fr: 'Aucun jeu ne correspond à ce filtre.' },
  'seznam.pocet': { cs: 'označených her', en: 'marked games', de: 'markierte Spiele', fr: 'jeux marqués' },
  'seznam.odznacit': { cs: 'Odznačit', en: 'Unmark', de: 'Markierung entfernen', fr: 'Retirer' },
  'seznam.vicPlatformy': { cs: 'Po platformách', en: 'By platform', de: 'Nach Plattform', fr: 'Par plateforme' },
  'seznam.vicSeznam': { cs: 'Souvislý seznam', en: 'Flat list', de: 'Fortlaufende Liste', fr: 'Liste continue' },
...
// ---- delka hrani ----
  ...
  'type.web.label': { cs: 'Web', en: 'Web', de: 'Web', fr: 'Web' },
  'type.web.tag': { cs: 'Flash, Java a HTML5 — hry na jedno kliknutí v prohlížeči.', en: 'Flash, Java and HTML5 — games one click away in the browser.', de: 'Flash, Java und HTML5 — Spiele einen Klick entfernt im Browser.', fr: 'Flash, Java et HTML5 — des jeux à un clic dans le navigateur.' },
