...
const UI: Dict = {
  ...
  'home.lead': {
    cs: 'Od arkádových automatů a osmibitových počítačů po dnešní konzole a virtuální realitu. Historie strojů, jejich nejlepší hry a tipy, kde si je zahrát dnes.',
    en: 'From arcade cabinets and 8-bit computers to today\u2019s consoles and virtual reality. The story of the machines, their best games and where to play them now.',
    de: 'Von Spielhallenautomaten und 8-Bit-Rechnern bis zu heutigen Konsolen und Virtual Reality. Die Geschichte der Maschinen, ihre besten Spiele und wo man sie heute spielt.',
    fr: 'Des bornes d\u2019arcade et des ordinateurs 8 bits aux consoles actuelles et à la réalité virtuelle. L\u2019histoire des machines, leurs meilleurs jeux et où y jouer aujourd\u2019hui.',
  },
