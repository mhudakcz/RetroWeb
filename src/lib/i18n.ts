...
// ---- uzivatelsky ucet a znacky u her ----
  ...
  'ucet.poslatKod': { cs: 'Poslat kód', en: 'Send code', de: 'Code senden', fr: 'Envoyer le code' },
  'ucet.kod': { cs: 'Kód z e-mailu', en: 'Code from the e-mail', de: 'Code aus der E-Mail', fr: 'Code reçu par e-mail' },
  'ucet.overit': { cs: 'Přihlásit', en: 'Sign in', de: 'Anmelden', fr: 'Connexion' },
  'ucet.kodOdeslan': { cs: 'Šestimístný kód jsme poslali na', en: 'We sent a six-digit code to', de: 'Wir haben einen sechsstelligen Code gesendet an', fr: 'Nous avons envoyé un code à six chiffres à' },
  'ucet.jinyEmail': { cs: 'Použít jiný e-mail', en: 'Use a different e-mail', de: 'Andere E-Mail verwenden', fr: 'Utiliser une autre adresse' },
  'ucet.znovu': { cs: 'Poslat kód znovu', en: 'Send the code again', de: 'Code erneut senden', fr: 'Renvoyer le code' },
  ...
  'ucet.lead': { cs: 'Přihlaste se e-mailem — heslo si pamatovat nemusíte. Pošleme vám kód, který jednou opíšete, a zůstanete přihlášení.', en: 'Sign in with your e-mail — no password to remember. We send you a code, you type it once and stay signed in.', de: 'Melden Sie sich mit Ihrer E-Mail an — kein Passwort nötig. Wir senden Ihnen einen Code, den Sie einmal eingeben, und bleiben angemeldet.', fr: 'Connectez-vous par e-mail — aucun mot de passe à retenir. Nous vous envoyons un code à saisir une fois, puis vous restez connecté.' },
