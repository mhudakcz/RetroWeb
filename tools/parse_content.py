...
PLATFORMS = [
    ...
    dict(slug="nds", name="Nintendo DS", short="DS", maker="Nintendo",
         year=2004, type="handheld", color="#2b7cd3", color2="#0e1f3a",
         aliases=["Nintendo DS / DS Lite", "NDS"]),
    dict(slug="3ds", name="Nintendo 3DS", short="3DS", maker="Nintendo",
         year=2011, type="handheld", color="#d23a3a", color2="#2a0d0d",
         aliases=["Nintendo 3DS / 2DS", "N3DS"]),
    ...
    dict(slug="psp", name="Sony PSP", short="PSP", maker="Sony",
         ...
         aliases=["Sony PSP"]),
    dict(slug="ps-vita", name="Sony PlayStation Vita", short="Vita", maker="Sony",
         year=2011, type="handheld", color="#2b5fd9", color2="#12172e",
         aliases=["Sony PlayStation Vita (PS Vita)", "PlayStation Vita", "PS Vita"]),
    ...
    dict(slug="ps2", name="Sony PlayStation 2", short="PS2", maker="Sony",
         year=2000, type="console", color="#2a3a8c", color2="#0d1226",
         aliases=["Sony PlayStation 2 (PS2)", "PlayStation 2"]),
    dict(slug="gamecube", name="Nintendo GameCube", short="GCN", maker="Nintendo",
         year=2001, type="console", color="#6a5acd", color2="#241f4a",
         aliases=["Nintendo GameCube (GCN)", "GameCube"]),
    dict(slug="wii", name="Nintendo Wii", short="Wii", maker="Nintendo",
         year=2006, type="console", color="#2e9bd6", color2="#0f2a3a",
         aliases=["Nintendo Wii"]),
    dict(slug="wii-u", name="Nintendo Wii U", short="Wii U", maker="Nintendo",
         year=2012, type="console", color="#1f8fc0", color2="#0d2130",
         aliases=["Nintendo Wii U"]),
    dict(slug="xbox", name="Microsoft Xbox", short="Xbox", maker="Microsoft",
         year=2001, type="console", color="#107c10", color2="#0a2a0a",
         aliases=["Microsoft Xbox (original)", "Xbox"]),
    dict(slug="xbox-360", name="Xbox 360", short="X360", maker="Microsoft",
         year=2005, type="console", color="#5dc21e", color2="#0f2a08",
         aliases=["Microsoft Xbox 360"]),
    dict(slug="ps3", name="Sony PlayStation 3", short="PS3", maker="Sony",
         year=2006, type="console", color="#1f6fd0", color2="#0c1830",
         aliases=["Sony PlayStation 3 (PS3)", "PlayStation 3"]),
    dict(slug="ps4", name="Sony PlayStation 4", short="PS4", maker="Sony",
         year=2013, type="console", color="#0a5ad0", color2="#0a142e",
         aliases=["Sony PlayStation 4 (PS4)", "PlayStation 4"]),
    dict(slug="ps5", name="Sony PlayStation 5", short="PS5", maker="Sony",
         year=2020, type="console", color="#1b4ecc", color2="#0a1024",
         aliases=["Sony PlayStation 5 (PS5)", "PlayStation 5"]),
    dict(slug="xbox-one", name="Xbox One", short="XONE", maker="Microsoft",
         year=2013, type="console", color="#0e8a0e", color2="#0a2410",
         aliases=["Microsoft Xbox One"]),
    dict(slug="switch", name="Nintendo Switch", short="Switch", maker="Nintendo",
         year=2017, type="console", color="#e60012", color2="#2a0a0c",
         aliases=["Nintendo Switch"]),
    dict(slug="xbox-series", name="Xbox Series X|S", short="Series", maker="Microsoft",
         year=2020, type="console", color="#3ba82f", color2="#0b1f0a",
         aliases=["Microsoft Xbox Series X", "Xbox Series X", "Xbox Series S"]),
    dict(slug="switch-2", name="Nintendo Switch 2", short="Switch 2", maker="Nintendo",
         year=2025, type="console", color="#d61f2b", color2="#2a0a10",
         aliases=["Nintendo Switch 2"]),
    dict(slug="mega-cd", name="SEGA Mega-CD", short="MCD", maker="SEGA",
         year=1991, type="console", color="#c0392b", color2="#2a0e0a",
         aliases=["SEGA Mega-CD", "Sega CD"]),
    dict(slug="sega-32x", name="SEGA 32X", short="32X", maker="SEGA",
         year=1994, type="console", color="#8e44ad", color2="#20102e",
         aliases=["SEGA 32X"]),
    dict(slug="sg-1000", name="SEGA SG-1000", short="SG", maker="SEGA",
         year=1983, type="console", color="#a03030", color2="#241010",
         aliases=["SEGA SG-1000"]),
    dict(slug="virtual-boy", name="Nintendo Virtual Boy", short="VB", maker="Nintendo",
         year=1995, type="console", color="#c8102e", color2="#1a0508",
         aliases=["Nintendo Virtual Boy", "Virtual Boy"]),
    dict(slug="ngpc", name="Neo Geo Pocket Color", short="NGPC", maker="SNK",
         year=1999, type="handheld", color="#e08a1e", color2="#2e1c06",
         aliases=["SNK Neo Geo Pocket Color", "Neo Geo Pocket"]),
    dict(slug="wonderswan", name="Bandai WonderSwan", short="WS", maker="Bandai",
         year=1999, type="handheld", color="#4a8fa8", color2="#122630",
         aliases=["Bandai WonderSwan", "WonderSwan Color"]),
    dict(slug="3do", name="3DO Interactive Multiplayer", short="3DO", maker="Panasonic / 3DO",
         year=1993, type="console", color="#5a6b7c", color2="#161c22",
         aliases=["3DO", "Panasonic 3DO"]),
    dict(slug="cd-i", name="Philips CD-i", short="CD-i", maker="Philips",
         year=1991, type="console", color="#3f7d5a", color2="#0f2418",
         aliases=["Philips CD-i", "CD-i"]),
    dict(slug="vectrex", name="GCE Vectrex", short="Vectrex", maker="GCE / Milton Bradley",
         year=1982, type="console", color="#d8d8d8", color2="#101010",
         aliases=["Vectrex", "GCE Vectrex"]),
    ...
    dict(slug="x68000", name="Sharp X68000", short="X68k", maker="Sharp",
         year=1987, type="computer", color="#6f7f95", color2="#161c26",
         aliases=["Sharp X68000", "X68000"]),
    dict(slug="pc-98", name="NEC PC-98", short="PC-98", maker="NEC",
         year=1982, type="computer", color="#8a7f6b", color2="#221e18",
         aliases=["NEC PC-98", "PC-9801", "PC-98"]),
    dict(slug="pc-dos", name="PC / DOS (XT až 486)", short="DOS", maker="IBM PC a klony",
         year=1981, type="computer", color="#d8a531", color2="#2a2008",
         aliases=["PC DOS", "MS-DOS", "IBM PC"]),
    dict(slug="pc-9x", name="PC / Pentium a Windows 9x", short="Win9x", maker="IBM PC a klony",
         year=1995, type="computer", color="#3a8fb7", color2="#14252e",
         aliases=["PC Windows 9x", "Windows 95", "Windows 98"]),
    dict(slug="pc-modern", name="PC / moderní (64bit a GPU)", short="PC", maker="PC platforma",
         year=2001, type="computer", color="#7a5cd6", color2="#1a1430",
         aliases=["PC", "Windows PC"]),
    ...
    dict(slug="java-mobil", name="Java a Symbian (telefony před smartphony)", short="Java ME",
         maker="Nokia, Siemens, Sony Ericsson", year=2001, type="mobile",
         color="#7ec8e3", color2="#12242e",
         aliases=["Java ME", "J2ME", "Java a Symbian"]),
    dict(slug="web", name="Webové hry (prohlížeč)", short="Web", maker="Flash, Java, HTML5",
         year=1996, type="web", color="#f0a020", color2="#2b1c05",
         aliases=["Webové hry", "Flash hry", "Prohlížečové hry"]),
